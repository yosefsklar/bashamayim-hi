...
export default class BHGame extends Component {
    ...
    return fetch(fetchString)
      ...
      .then((data) => {
        ...
        this.retrieveHaftorah(
          data,
          data.calendar_items.findIndex((item) => item.title.en === "Haftarah"),
        );
        this.retrieve929(
          data,
          data.calendar_items.findIndex((item) => item.title.en === "929"),
        );
        this.setGameDefault();
      })
      .catch((err) => {
  ...
  retrieveHaftorah = (data, index) => {
    ...
    this.setState({
      haftorah: new TextItem(
        haftorahText,
        haftorahStartChapter,
        haftorahName,
        haftorahEndChapter,
        haftorahStartVerse,
        haftorahEndVerse,
  ...
  render() {
    ...
    if (this.state.gameState === GameState.default) {
      ...
      toRender = <GameInstructions setGameDefault={this.setGameDefault} />;
